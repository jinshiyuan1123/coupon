...
<head>
	...
	<meta name="keywords" content="{{ $_system_config->description }}">
		...
		<link rel="stylesheet" href="{{ asset('/web/css/portal.base.min.css?v=1535436384237752') }}" type="text/css"/>
		<!--[if IE 6]>
		<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('/web/css/ie6.css?v=1535436384237752') }}"/>
		<![endif]-->
		<!--[if IE 7]>
		<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('/web/css/ie7.css?v=1535436384237752') }}"/>
		<![endif]-->
		<!--[if IE 8]>
		<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('/web/css/ie8.css?v=1535436384237752') }}"/>
		<![endif]-->
		...
		<link rel="stylesheet" href="{{ asset('/web/css/index.css?v=1535436384237752') }}" type="text/css"/>	
