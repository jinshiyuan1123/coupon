    ...
    <div class="m_container">
        <div class="m_body">
            <div class="container-fluid gm_main">
				...
				<div class="nichen"><strong>{{$business['Businessname']}}</strong></div>
				  <div class="inputb">
				  消费总额&nbsp;
                  ...
                  <div class="inputb">优惠券：满{{$data['term']}}元减{{$data['decrease']}}元</div>
...
//alert("aaa"); 
  ...
  var score=$('#score').val();
	  ...
	  if(allmoney>={{$data['term']}}){
		  money=allmoney-{{$data['decrease']}};
	  }
	  money=money-(score*{{$sys['outscorescale']}});
	  getscore=money*{{$sys['inscorescale']}};
	  $('.money').html(money);
