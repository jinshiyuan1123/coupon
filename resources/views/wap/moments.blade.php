	...
	<div class="container">
		...
		<div class="right_con">
			<div class="demo">
            	<!--用户名and发布时间-->
            	<div class="use">
                	<div class="usename"><span>{{$v->nichen}}</span><em class="pub-time">{{$v->created_at}}</em></div>
                </div>
                <!--分享的内容-->
                <p class="fx_content">{{$v->content}}</p>
                <!--分享的图片-->
