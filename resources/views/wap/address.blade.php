...
@section('content')
<script type="text/javascript" src="{{ asset('/wap/js/area.js') }}"></script>
        ...
        <div class="m_body2">
            <div class="container-fluid gm_main">
                ...
                <div class="userInfo setCard">
                    <form action="{{ route('wap.post_address') }}" method="post" name="form1">
                        <dl>
                            <dt>收货人信息</dt>
                            <dd>
                                <div class="pull-left">
                            ...
                            <dd>
                                ...
                                <div class="pull-right">
                                   {{ $_member->address1 }} - {{ $_member->address2 }} - {{ $_member->address3 }} - {{ $_member->address4 }} - {{ $_member->addressname }} - {{ $_member->addressphone }}
                                </div>
                            </dd>							
                        </dl>
                        ...
                        <dl class="set_card">
                            ...
                            <dd>
                                ...
                                <input id="addressname" class="pull-left" type="text" placeholder="收货人" name="addressname" value="{{ $_member->addressname }}">
                            </dd>						
                            <dd>
                                <div class="pull-left">
                                    省
                            ...
                            <dd>
                                ...
                                <input class="pull-left" type="text" placeholder="街道/门牌号" name="address4" value="{{ $_member->address4 }}">
                            </dd>							
                            @if($_system_config->is_sms_on == 0)
                            <dd>
                                <div class="pull-left">手机号</div>
                                <input id="addressphone" class="pull-left m_phone" type="text" placeholder="手机号" name="addressphone" value="{{ $_member->addressphone }}">
...
Gid('s_county').setAttribute('onchange','showArea()');
    ...
    <script>
        var addressphone_url = "{{ route('sendSms') }}";
