                    ...
                    <form action="{{ route('wap.post_bind_bank') }}" method="post" name="form1">
                        ...
                        <dl class="set_card">
                            ...
                            <dd>
                                ...
                                <input id="bank_username" class="pull-left" type="text" placeholder="开户人名字" name="bank_username" value="{{ $_member->real_name }}">
                            </dd>
                            <dd>
                                <div class="pull-left">
                                    收款银行
                            ...
                            <dd>
                                ...
                                <input id="pay_num" class="pull-left" type="number" placeholder="银行账号" name="bank_card"  value="{{ $_member->bank_card }}">
                            </dd>
                            <dd>
                                <div class="pull-left">开户行地址</div>
                                <input id="pay_address" class="pull-left" type="text" placeholder="开户行地址"
                                       name="bank_address"  value="{{ $_member->bank_address }}">
                            </dd>
                            <dd>
                                <div class="pull-left">开户行网点</div>
                                <input id="pay_address" class="pull-left" type="text" placeholder="开户行网点"
                                       name="bank_branch_name"  value="{{ $_member->bank_branch_name }}">
                            </dd>
                            ...
                            <dd>
                                ...
                                <input id="v_phone" class="pull-left m_phone" type="text" placeholder="手机号"
                                       name="phone" value="{{ $_member->phone }}">
