                            ...
                            <form class="form-horizontal" id="form" action="{{ route('system_config.update', ['id' => 1]) }}" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="number" class="form-control" id="active_member_money2" name="active_member_money2"  value="{{ $data->active_member_money2 }}" />
                                        </div>
                                    </div>									
                                </div><!-- /.box-body -->
                                <div class="box-footer">
                            ...
                            <form class="form-horizontal" id="form" action="{{ route('system_config.update', ['id' => 1]) }}" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="sms_url" name="sms_url" placeholder="例：http://api.123456.com_addref" value="{{ $data->sms_url }}"  />
                                        </div>
                                    </div>
                                    <!---<div class="form-group">
