                 ...
                 <table class="table table-bordered table-hover text-center">
                     ...
                     @foreach($data as $item)
                         <tr>
                             ...
                             <td>
                                <a href="{{$item->idcard}}" target="_blank"> <img src="{{$item->idcard}}" width="50px" height="50px" /></a>
                             </td>	
                             <td>
                                  <a href="{{$item->Business}}" target="_blank"> <img src="{{$item->Business}}" width="50px" height="50px" /></a>
                             </td>
                             <td>
							 {{$item->about}}
                             </td>								 
