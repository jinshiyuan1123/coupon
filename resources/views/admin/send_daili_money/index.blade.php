                 ...
                 <table class="table table-bordered table-hover text-center">
                     ...
                     @foreach($data as $item)
                         ...
                         <tr>
							 ...
							 <?php
							$api=new \App\Http\Controllers\Admin\SendDailiMoneyController();
							$toal_validBetAmount=$api->TotalNetAmount($item->id,1);
                            $total_drawing=$api->TotalNetAmount($item->id,2);
						    ?>	
                             <td><?=$toal_validBetAmount?></td><td><?=$total_drawing?></td>
