...
class YcController  extends WebBaseController
{
    ...
    public function login(Request $request)
    {
        ...
        $platformCode = $request->get('platformCode')?:'YC';
        ...
        return view('web.lottory_show', compact('res'));

    }

    public function game_record()
    {
        return view('api.getRecord_yc');
    }
