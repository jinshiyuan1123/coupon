...
use DB;
class GgController extends WebBaseController
{
    protected $service,$api;
    public function __construct()
    {
        $this->service = new TcgService();
        $this->api = Api::where('api_name', 'GG')->first();
    }
    ...
    public function balance($username, $password)
    {
        ...
        $res = json_decode($this->service->balance($username, 7), TRUE);
    ...
    public function deposit($username, $password, $amount, $amount_type = 'money')
    {
        ...
        $bill_no = getBillNo();
        $result = $this->service->transfer($username, 7,1,$amount,$bill_no);
    ...
    public function withdrawal($username, $password, $amount, $amount_type = 'money')
    {
        ...
        $bill_no = getBillNo();
        $result = $this->service->transfer($username, 7,2,$amount,$bill_no);
        $res = json_decode($result, TRUE);
    ...
    public function login(Request $request)
    {
        ...
        $product_type = $request->get('product_type')?:7;
