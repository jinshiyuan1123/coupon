        ...
        <div class="m_body2">
            ...
            <div class="m_wrapper clear">
                <div class="m_member-title1 clear textCenter">
                    ...
                    我的动态
					<a href="<?php echo e(route('wap.releasemoments')); ?>" class="pull-right" style="color:#00BCD4">发动态</a>
                </div>
	...
	<div class="container">
		...
		<div class="right_con">
			<div class="demo">
            	<!--用户名and发布时间-->
            	<div class="use">
                	<div class="usename"><a href="<?php echo e(route('wap.mymoments')); ?>/<?php echo e($v->id); ?>" style="color:#ed4947;"><span><?php echo e($v->nichen); ?></span></a><em class="pub-time"><?php echo e($v->created_at); ?></em></div>
                </div>
                <!--分享的内容-->
                <p class="fx_content"><a href="<?php echo e(route('wap.mymoments')); ?>/<?php echo e($v->id); ?>" style="color:#4a4848;"><?php echo e($v->content); ?></a></p>
                <!--分享的图片-->
