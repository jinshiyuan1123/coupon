     ...
     <section class="content">
         <div class="panel panel-primary">
             ...
             <div class="panel-body">
                 <?php echo $__env->make('admin.moments.filter', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                 <table class="table table-bordered table-hover text-center">
                     ...
                     <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         <tr>
                             ...
                             <td>
                                <a href="/admin/moments?mentsclassID=<?php echo e($item->cnameid); ?>"> <?php echo e($item->Momentsclass); ?></a>
                             </td>
                             <td>
                           ...
                           <button class="btn btn-danger btn-xs"
                                         data-url="<?php echo e(route('moments.destroy', ['id' => $item->getKey()])); ?>"
                                         data-toggle="modal"
                 ...
                 <div class="pull-right" style="margin: 0;">
                     <?php echo $data->appends(['start_at' => $start_at,'mentsclassID' => $mentsclassID,'end_at' => $end_at])->links(); ?>
