        ...
        <div class="m_body2">
            <div class="container-fluid gm_main">
                ...
                <div class="userInfo setCard">
                    <form action="<?php echo e(route('wap.postreleasemoments')); ?>" method="post" name="form1">
                        <dl class="set_card">
                            <dd>
                                <select name="momentsclass" style="width:90%;"> 
                            <?php $__currentLoopData = $MomentsClass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>								
							    ...
							    <!--添加图片-->
									...
									<div id="upimages">
										...
										<div class="inside-image-box addimg">
											<img class="addimg-loading" src="<?php echo e(asset('/wap/images/addimg.png')); ?>" alt="">
										</div>				

									</div>
                                <!--添加图片-->	
				</div>				
			<form id="uploadForm" action="<?php echo e(route('wap.uploads')); ?>" method="post"">
...
$(function (e) {
    $("#uploadForm").on('submit', function(e){
        e.preventDefault();
        $.ajax({
            url: "<?php echo e(route('wap.uploads')); ?>",
            type: "POST",
            ...
            // 显示加载图片
            beforeSend: function () {
				$('.addimg-loading').attr('src', '<?php echo e(asset('/wap/images/loading.gif')); ?>');
            },
            success: function (data) {
                // 移除loading加载图片
				if(num>=8){	
                    $('.addimg-loading').attr('src', '<?php echo e(asset('/wap/images/addimg.png')); ?>');
