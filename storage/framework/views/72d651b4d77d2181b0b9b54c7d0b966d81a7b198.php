<?php $__env->startSection('content'); ?>
    <div class="m_container">
        <div class="">
            <div class="m_login">
                <img src="<?php echo e(asset('/wap/images/bg_register.png')); ?>" alt="">
                <div class="m_login-form">
                    <form id="form1"  action="<?php echo e(route('wap.register.post')); ?>" method="post" name="form1">
                        ...
                        <div class="m_login-field captcha">
                            ...
                            <a onclick="javascript:re_captcha();" ><img src="<?php echo e(URL('kit/captcha/1')); ?>" id="c2c98f0de5a04167a9e427d883690ff6"></a>
                            <script>
                                function re_captcha() {
                        ...
                        <div class="m_login-field textRight">
                            <a href="<?php echo e(route('wap.login')); ?>" class="m_forget-pwd">已有账号?立即登录</a>
                        </div>
                        <div class="m_login-field">
    ...
    <script>
        var set_phone_url = "<?php echo e(route('sendSms')); ?>";
